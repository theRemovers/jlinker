...
let check_reloc = function
  | [] -> ()
  | _ :: _ ->
      failwith "unsupported relocation information in Absolute COFF export"
...
let save_object filename
    ( { Linker.text_address; data_address; bss_address },
      { Aout.text; data; bss_size; text_reloc; data_reloc; _ } ) =
  let open Emit in
  ...
  emit_word oc 0x0150l;
  (* magic *)
  emit_word oc 0x3l;
  (* 3 sections *)
  emit_long oc 0l;
  (* timestamp *)
  emit_long oc (Int32.of_int (header_size + text_size + data_size));
  (* offset to symbols *)
  emit_long oc 0l;
  (* no symbols [TODO?] *)
  emit_word oc 28l;
  ...
  emit_long oc textbase;
  emit_long oc (Int32.of_int text_size);
  emit_long oc (Int32.of_int header_size);
  (* offset to text *)
  emit_long oc 0l;
  (* offset to section reloc *)
  emit_long oc 0l;
  (* offset to debug lines *)
  emit_long oc 0l;
  (* nreloc *)
  emit_long oc 0x20l;
  (* STYP_TEXT *)
  ...
  emit_long oc database;
  emit_long oc (Int32.of_int data_size);
  emit_long oc (Int32.of_int (header_size + text_size));
  (* offset to data *)
  emit_long oc 0l;
  (* offset to section reloc *)
  emit_long oc 0l;
